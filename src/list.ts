...
var predicates = function () {
    ...
    return {
        ...
        // length/2
        "length/2": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
        ...
        // replicate/3
        "replicate/3": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
        ...
        // sort/2
        "sort/2": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
        ...
        // msort/2
        "msort/2": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
            var list = atom.args[0], expected = atom.args[1];
            if (pl.type.is_variable(list)) {
                thread.throw_error(pl.error.instantiation(atom.indicator));
            } else if (!pl.type.is_variable(expected) && !pl.type.is_fully_list(expected)) {
        ...
        // keysort/2
        "keysort/2": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
            var list = atom.args[0], expected = atom.args[1];
            if (pl.type.is_variable(list)) {
                thread.throw_error(pl.error.instantiation(atom.indicator));
            } else if (!pl.type.is_variable(expected) && !pl.type.is_fully_list(expected)) {
        ...
        // take/3
        "take/3": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
            ...
            if (pl.type.is_variable(list) || pl.type.is_variable(number)) {
                ...
                if (i === 0) {
                    ...
                    for (var i: any = arr.length - 1; i >= 0; i--) {
        ...
        // drop/3
        "drop/3": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
        ...
        // reverse/2
        "reverse/2": function (thread: { throw_error: (arg0: any) => void; prepend: (arg0: any[]) => void; }, point: { goal: { replace: (arg0: any) => any; }; substitution: any; }, atom: { args: any[]; indicator: any; }) {
        ...
        // list_to_set/2
        "list_to_set/2": function (thread: any, point: any, atom: any) {
...
var exp = ["append/2", "append/3", "member/2", "permutation/2", "maplist/2", "maplist/3", "maplist/4", "maplist/5", "maplist/6", "maplist/7", "maplist/8", "include/3", "exclude/3", "foldl/4", "sum_list/2", "max_list/2", "min_list/2", "prod_list/2", "last/2", "prefix/2", "nth0/3", "nth1/3", "nth0/4", "nth1/4", "length/2", "replicate/3", "select/3", "sort/2", "msort/2", "keysort/2", "take/3", "drop/3", "reverse/2", "list_to_set/2"];

export function load(p: any) {
    pl = p;
    new pl.type.Module("lists", predicates(), exp);
}
